...
void Jacobi::jacobi_method(double **A, int n)
{
    int iterations = 0;
    int k, l;
    double eps = 1.0e-8;
...
void Jacobi::jacobi_method(double **A, double **R, int n)
{
    int iterations = 0;
    int k, l;
    double eps = 1.0e-8;
...
void Jacobi::rotate(double **A, int k, int l, int n)
{
    double tau;
    double s, c, t;
    double A_ik, A_kk;
...
void Jacobi::rotate(double **A, double **R, int k, int l, int n)
{
    double tau;
    double s, c, t;
...
double Jacobi::max_off_diag(double **A, int *k, int *l, int n)
{
    double A_max = 0.0;
    for (int i = 0; i < n; i++){
        for (int j = i+1; j < n; j++){
